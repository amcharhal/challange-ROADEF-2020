...
public:
	...
	int getResourceId(const std::string& ar_resourceName) const { return m_resourcesMap.find(ar_resourceName)->second; }
	...
	int getInterventionId(const std::string& ar_interventionName) const { return m_interventionsMap.find(ar_interventionName)->second; }
